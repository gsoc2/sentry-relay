...
impl Project {
    ...
    fn flush_metric_meta(
        ...
        // TODO: evict if project does not exist, actual 404 from Sentry or w/e
        ...
        if !state.has_feature(Feature::MetricMeta) {
            ...
            // TODO: there is a potential edge case where the feature flag gets toggled.
            // We would still de-depulicate in Redis but this a potential attack vector.
            // Can orgs toggle this on their own?
            self.metric_meta_aggregator.clear(self.project_key);
            return;
        }

        // TODO: we overflush here, but this is fine (surely). Actually figure this out ...
